...
const EditApartment = () => {
  ...
  const baseURLApartment = "http://localhost:8080/api/v1/apartment/" + id;
...
const accessToken = localStorage.getItem("accessToken");
    ...
    axios
      .put(
        "http://localhost:8080/api/v1/apartment/" + id,
        {
          name: name,
          number: number,
          area: area,
